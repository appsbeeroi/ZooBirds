...
struct HealthVaccinationCellView: View {
    ...
    var body: some View {
        SwipeView {
            Button {
                ...
                HStack {
                    let firstFreeBirds = birds.filter { vaccination.birdIDs.contains($0.id) }.prefix(3)
...
#Preview {
    HealthVaccinationCellView(vaccination: Vaccination(isMock: true), birds: [Bird(isMock: true)]) {} editAction: {} removeAction: {}
}
